...
(function () {
  ...
  function buildCover(item, posterSrc, fit) {
    ...
    // Инлайн SVG, не CSS mask-image: -webkit-mask-image на элементе
    // внутри backdrop-filter — известный баг мобильного Safari, маска
    // отваливается и вместо иконки рисуется сплошной квадрат заливки.
    // Инлайн не зависит от загрузки отдельного файла и от этого бага.
    playBtn.innerHTML =
      '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">' +
      '<path d="M19 10.2679C20.3333 11.0377 20.3333 12.9623 19 13.7321L10 18.9282C8.66667 19.698 7 18.7358 7 17.1962L7 6.80385C7 5.26425 8.66667 4.302 10 5.0718L19 10.2679Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>' +
      '</svg>';
