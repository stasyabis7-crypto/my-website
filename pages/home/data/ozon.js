...
window.projectCollections = {
  ...
  ozon: [
    ...
    image: i === 3 ? `/pages/home/assets/ozon/4-original.webp` : i < 3 || i === 7 ? `/pages/home/assets/ozon/${i + 1}-1920.webp?v=3` : `/pages/home/assets/ozon/${i + 1}-1280.webp`,
    srcset: i === 3
      ? `/pages/home/assets/ozon/4-original.webp 1302w`
      : i < 3 || i === 7
      ? `/pages/home/assets/ozon/${i + 1}-640.webp?v=3 640w, /pages/home/assets/ozon/${i + 1}-1280.webp?v=3 1280w, /pages/home/assets/ozon/${i + 1}-1920.webp?v=3 1920w`
      : `/pages/home/assets/ozon/${i + 1}-640.webp 640w, /pages/home/assets/ozon/${i + 1}-1280.webp 1280w`,
    color: '#EEF0F4'
  }))
};
